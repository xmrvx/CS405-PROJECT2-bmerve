...
void main()
{
    ...
    float ambient = 0.35;                            // Ambient lighting constant
    float diff = 0.0;                                // Placeholder for diffuse
    float spec = 0.0;                                // Placeholder for specular
    float phongExp = 8.0;                            // Shininess factor
